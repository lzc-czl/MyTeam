...
#define loaderViewInitFrame  (CGRectMake(0, 0, IISCREEN_WIDTH, ((IOS7_OR_LATER?IISCREEN_HEIGHT:IISCREEN_HEIGH)-44)))
#define loaderViewInitCenter   (CGPointMake(IISCREEN_WIDTH/2, (IOS7_OR_LATER?IISCREEN_HEIGHT:IISCREEN_HEIGH)/2-44))
